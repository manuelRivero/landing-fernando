...
export default function Header({ onToggleMenu }: Props) {
  ...
  return (
    <header
      ...
      } container mx-0 fixed md:absolute top-0 left-1/2 -translate-x-1/2 p-8 lg:p-16 z-10`}
    >
      <div className="flex flex-row justify-between">
        <div className="flex flex-row justify-center items-center">
          <img src={location.pathname === "/" ? zapianLogo : zapianLogoBlue} alt="Zapian logo" />
        </div>
        <div className="flex flex-row justify-center items-center">
          <img
            src={location.pathname === "/" ? burguerMenu : burguerMenuBlue}
            alt="Burguer menu"
