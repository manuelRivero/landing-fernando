...
export default function Layout({ children }: LayoutProps) {
  ...
  const handleMenuIconColor = (location: string): string => {
    console.log(location);
    
    if (location === "/") return "#5A56ED";
    else if (location === "/growth-and-funnel/") return "#F8C332";
    else if (location === "/web-and-app/") return "#1BE4A5";
    else return "#5A56ED";
  };
        ...
        <div className="relative">
          ...
          >
            <div
              ref={menuRef}
              className={`bg-${
                location.pathname === "/" ? "customPink-500" : "customBlue-600"
            ...
            >
              ...
              >
                <path
                  ...
                  fill={handleMenuIconColor(location.pathname)}
                />
              </svg>
