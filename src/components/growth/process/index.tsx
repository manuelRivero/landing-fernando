  ...
  return (
    <div className="bg-white">
      <div className="pt-32 lg:pt-52 pb-32 lg:pb-40 px-8 md:px-32 container">
        <h1 className="text-customBlue-600 text-center lg:text-left font-inter font-bold text-2xl md:text-3xl uppercase leading-tight lg:leading-customLineHeight">
          Process
        </h1>
