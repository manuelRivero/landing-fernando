        ...
        <div>
          ...
          >
            ...
            >
              ...
              <motion.div
                initial={{ opacity: 0 }}
                animate={showSlideInfo === 1 ? { opacity: 1 } : { opacity: 0 }}
                  ...
                  <div className="relative w-fit">
                    ...
                    <div className="absolute w-full h-full top-0 left-0 font-inter text-customBlue-600 p-8 flex flex-col justify-between">
                      ...
                      <div className="flex flex-col space-y-4">
                        ...
                        <div>
                          <p className="text-tight leading-tight">Flexible</p>
                          <p className="text-tight leading-tight font-bold">
                            Including copy in 2 channels(s) (Meta, Meta Ads)
                          </p>
                          <p className="text-tight leading-tight font-bold">
                            Including design in 2 channels(s) (Meta, Meta Ads)
                          </p>
                        </div>
                      </div>
                    </div>
            ...
            >
              ...
              <motion.div
                initial={{ opacity: 0 }}
                animate={showSlideInfo === 2 ? { opacity: 1 } : { opacity: 0 }}
                transition={{ duration: 0.5, ease: "easeOut" }} // Transición suave sin rebote
                className={`absolute top-0 left-0 h-full`}
              >
                <div className="flex justify-center">
                  <div className="relative w-fit">
                    ...
                    <div className="absolute w-full h-full top-0 left-0 font-inter text-customBlue-600 p-8 flex flex-col justify-between">
                      ...
                      <div className="flex flex-col space-y-4">
                        <div>
                          <p className="text-3xs leading-tight">Advertising</p>
                        ...
                        <div>
                          ...
                          <p className="text-3xs leading-tight font-bold">
                            Including design in 3 channels(s) (Meta, Meta Ads,
                            Email)
                          </p>
                        </div>
                      </div>
            ...
            >
              ...
              <motion.div
                initial={{ opacity: 0 }}
                animate={showSlideInfo === 3 ? { opacity: 1 } : { opacity: 0 }}
                transition={{ duration: 0.5, ease: "easeOut" }} // Transición suave sin rebote
                className={`absolute top-0 left-0 h-full`}
              >
                <div className="flex justify-center">
                    ...
                    <div className="absolute w-full h-full top-0 left-0 font-inter text-customBlue-600 p-8 flex flex-col justify-between">
                      ...
                      <div className="flex flex-col space-y-4">
                        ...
                        <div>
                          ...
                          <p className="text-3xs leading-tight font-bold">
                            6 monthly contents (4 Email, 2 WhatsApp broadcast)
                          </p>
                        </div>
                        <div>
                          <p className="text-3xs leading-tight">Flexible</p>
                          ...
                          <p className="text-3xs leading-tight font-bold">
                            Including design in 4 channels(s) (Meta, Meta Ads,
                            Email, WhatsApp)
                          </p>
                        </div>
                      </div>
