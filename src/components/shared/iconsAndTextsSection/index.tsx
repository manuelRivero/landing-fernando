  ...
  return (
    <div>
      <div className="grid grid-cols-12 gap-16">
        {IncubatorContent.map((item, index: number) => (
          <div
          ...
          >
            {item.icon}
            <h3 className="text-white uppercase text-normal font-bold text-center">{item.title}</h3>
            <h3 className="text-white text-2xs text-center">{item.description}</h3>
          </div>
        ))}
      </div>
    </div>
