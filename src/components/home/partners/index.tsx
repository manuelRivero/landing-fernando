    ...
    <div className="bg-black">
      <div className="py-16 md:py-32 md:pb-40 px-8 md:px-32 container">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-11">
          <h2 className="text-white text-center lg:text-left  font-bold text-2xl md:text-3xl uppercase leading-none">
            We’ve got the trust of
          </h2>
          <h3 className="text-white text-center lg:text-left  font-bold text-xs md:text-normal leading-tight">
