          ...
          <div className="flex flex-col justify-center items-center space-y-12">
            <div>
              ...
              <p className="text-white text-center text-xs md:text-normal mt-8 md:mt-0">
                If you're not ready to apply for the Exclusive Incubator
                Program, begin your journey with a personalized coaching
                session. Our experts will guide you on strategic decisions,
