            ...
            <div className="flex flex-col space-y-4 items-center lg:items-start">
              <div>
                <h1 className="text-white text-center lg:text-left font-inter font-bold text-[56px] md:text-3xl uppercase mb-4 md:mb-0 leading-tight">
                  <span className="text-customGreen-500">Incubator</span>{" "}
                  Program
                </h1>
                <p className="text-white text-center lg:text-left text-xs md:text-normal leading-none">
                  Transform your business with{" "}
                  <span className="font-semibold italic">Zapian's</span>{" "}
                  Incubator Program – a high-impact initiative tailored for
                  pre-seed startups.{" "}
                  <span className="font-semibold">
                    Unleash your business's potential
                  </span>{" "}
                  with our specialized support, strategic guidance, and
                  exclusive resources.
                </p>
              </div>
            </div>
